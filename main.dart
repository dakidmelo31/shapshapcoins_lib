...
import 'receive_money/confirm_recipient.dart';
import 'receive_money/no_sender_found.dart';
import 'send_money/phone_number.dart';
import 'send_money/receive_funds.dart';
import 'receive_money/request_sent.dart';
  ...
  Widget build(context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        ConfirmRecipient.routeName: (context) => const ConfirmRecipient(),
        ...
        RequestSent.routeName: (context) => const RequestSent(),
        NoSenderFound.routeName: (context) => const NoSenderFound(),
